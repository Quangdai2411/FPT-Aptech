        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="footer-left">
                    ...
                    <ul>
                        <li>85 Xuan Thuy . Ha Noi</li>
                        <li>Phone: +84 37.78.17.172</li>
                        <li>Email: doquangdai21@gmail.com</li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copyright-text">
                        Copyright @<script>document.write(new Date().getFullYear())</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="Magnus.vn" target="_blank">Magnus</a>
                    </div>
